...
namespace HxModel.Models
{
	...
	struct VehicleCtrl
	{
		...
		public double Trimmer; // признак нажатия кнопки триммера продольно-поперечного упрвления
		public double Friction; // признак нажатия кнопки фиркциона общего шага
