...
namespace DataTransfer.Model.Structs
{
	...
	class CockpitKa50 : Base
	{
		...
		public void UpdateRus(JoystickState joystickState)
		{
				...
				Elevator = (float)(1-(65535.0 - joystickState.Y) / 65535.0 * 1);
			    
				
				
				
				Aileron = (float)(1-( 65535.0 - joystickState.X) / 65535.0 * 1);
		...
		{
			Rudder = 0;// (float)(-(1 - joystickState.Z / 32767.0) * 81.49);
		}

		public void UpdateRud(JoystickState joystickState)
		{
			Throttle  = (float)((65535.0 - joystickState.RotationZ) / 65535.0 * 1);
		}
